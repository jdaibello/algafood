...
public interface CityControllerOpenApi {
    ...
    @ApiResponses({
            ...
            @ApiResponse(
                    ...
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = Problem.class)))})
    CityDTO find(@ApiParam(value = "ID da cidade", example = "1") Long cityId);
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "Cidade atualizada"),
            ...
            @ApiResponse(
                    ...
                    description = "Cidade não encontrada",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = Problem.class)))})
    CityDTO update(@ApiParam(value = "ID da cidade", example = "1") Long cityId, CityInput city);
    ...
    @ApiResponses({@ApiResponse(responseCode = "204", description = "Cidade excluída"),
            ...
            @ApiResponse(
                    ...
                    description = "Cidade não encontrada",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = Problem.class)))})
    void delete(@ApiParam(value = "ID da cidade", example = "1") Long cityId);
}
